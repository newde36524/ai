...
func chatGPT(msg []Message, output io.Writer) error {
	...
	req.Header.Add("authorization", "Bearer sk-dAvQZpNPgLyJlhVJFudQR64MEkWqZHtMbOGMwGoIq1U5")
	//sk-rmkNimoGp5tjFzm3PCR9QxwajCZza2wF1274xWMRks4U
	//sk-pwwFClSFPKyjwrvsfZeVsll6kSAXm93R7UgVgyVbsR4s
	//sk-8vKOPppgKdAePUCWTT6UuZpcycZbhNrmBH09rw2v5fi9
